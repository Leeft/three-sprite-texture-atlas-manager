import { Math as Math$1, Texture, UVMapping } from 'three/build/three.js';
...
var KnapsackNode = /*#__PURE__*/function () {
  ...
  _createClass(KnapsackNode, [{
    ...
    value: function claim() {
      this.imageID = Math$1.generateUUID(); // Some crude painting to help troubleshooting
  ...
  _createClass(Knapsack, [{
    ...
    get: function get() {
      if (!this._rootTexture) {
        this._rootTexture = new Texture(this.canvas, UVMapping);
      }
...
//# sourceMappingURL=three-sprite-texture-atlas-manager.es6.js.map
